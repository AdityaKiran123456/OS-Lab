...
void Kernel::PriorityTest() {
    Thread* t1 = new Thread("low");
    Thread* t2 = new Thread("medium");
    Thread* t3 = new Thread("high");

    t1->setPriority(1);
    t2->setPriority(5);
    t3->setPriority(10);

    // Fork in reverse priority order to prove scheduler reorders them
